...
if __name__ == "__main__":
    ...
    input_dir = r"E:\0812data\DJI_202508121500_009_lichi-20250808T_25meters"
    output_dir = r"E:\0812data\DJI_202508121500_009_lichi-20250808T_25meters_254043"
    # "distance", "humidity", "emissivity", "reflection"
    run(input_dir, output_dir, distance=25, humidity=40, emissivity=0.95, reflection=43)
#     项目任务：                 高度 50米     相对湿度85%  土壤、泥土反射率0.90-0.98 反射温度 环境温度28.5
#     默认参数：                 高度 10米     相对湿度70%  土壤、泥土反射率0.90-0.98 反射温度 环境温度 40
#               经测试发现，测温距离最大可设置25m